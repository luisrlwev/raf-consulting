...
/*** change visit nav */
var VisitPage = sessionStorage.getItem('page-visit');
...
$(".btn-movil-menu").click(function () {
    $(".menu-nav-movil-slide").toggleClass("open-menu-movil-class");
});
(function ($) {
    "use strict";
        ...
        if ($('.menu-area').length) {
            $(window).on('scroll', function () {
                if ($(window).scrollTop() > 140) {
                    ...
                    $('.search-consultant').addClass('search-consultant-fixed');
                } else {
                    $('.menu-area').removeClass('navbar-fixed-top');
                    $('.logo').removeClass('logo-fixed');
                    $('.menu').removeClass('menu-fixed');
                    $('.search-consultant').removeClass('search-consultant-fixed');
                }
            });
        }
    }
    ...
    $('.cf-msg').hide();
    $('form#fc button#submit').on('click', function () {
        var fname = $('#fname').val();
        var email = $('#email').val();
        var msg = $('#msg').val();
    ...
    $('form#newsletterForm').on('submit', function () {
        ...
        if (email != '') {
            ...
            $.ajax({
                ...
                success: function (resp) {
                    $('#email').val('');
                    alert('Email has been recorded successfully');
            ...
            alert('Please fillup the informations correctly');
            $(document.body).css({ 'cursor': 'default' });
        }
        return false;
    });
